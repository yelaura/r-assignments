...
First, calculate the statistics by query_time.
Time of day is split 

```{r, echo=TRUE, comment=NA, warning=FALSE, message=FALSE}
require(lubridate)

sessions_stats$session_started_at <- as.POSIXct(sessions_stats$session_started_at, format = "%Y-%m-%d %H:%M", tz= "")
